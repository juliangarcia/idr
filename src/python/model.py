...
graph_function_map = {
    ...
    "two_communities": lambda number_of_agents, number_of_0_tags, density: two_communities_graph(number_of_agents,
                                                                                                 number_of_0_tags,
                                                                                                 density),
    "well_mixed": lambda number_of_agents, number_of_0_tags, density: well_mixed_graph(number_of_agents,
                                                                                       number_of_0_tags, density),
