...
class Two_Agent_Model:
    ...
    def reinforce(self, policy_estimator, number_of_episodes, number_of_steps,
        ...
        print("end of pretraining ", self.belief[0], action)
        self.belief[0] = initial_belief

        ep = 0
        while ep < number_of_episodes:
            states = []
            rewards = []
            actions = []
...
if __name__ == "__main__":
    ...
    rewards, beliefs = model.reinforce(policy_est, 100, 1000, 100, 1000, 10, 0.99, 0.00)
